...
- [🧩 Modules Deep Dive](#-modules-deep-dive)
  ...
  - [🌍 Module 2 — Store Mode Engine](#-module-2--store-mode-engine)
  - [📦 Module 3 — Product Management](#-module-3--product-management)
  - [🧾 Module 4 — Order Management \& Invoicing](#-module-4--order-management--invoicing)
  - [👤 Module 5 — Customer CRM](#-module-5--customer-crm)
  - [📊 Module 6 — Business Analytics (Power BI Style)](#-module-6--business-analytics-power-bi-style)
  - [📉 Module 7 — Inventory Alert System](#-module-7--inventory-alert-system)
  - [💰 Module 8 — Profit \& Loss Engine](#-module-8--profit--loss-engine)
...
- [🚀 Installation \& Run](#-installation--run)
  ...
  - [Steps](#steps)
- [☁️ Deploy on Streamlit Cloud](#️-deploy-on-streamlit-cloud)
